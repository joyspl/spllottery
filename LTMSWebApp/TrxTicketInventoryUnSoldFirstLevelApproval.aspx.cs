...
{
    public partial class TrxTicketInventoryUnSoldFirstLevelApproval : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("<<--All-->>", "-80"));
                items.Add(new ListItem("Pending", "51"));
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    if (StatusVal == 51) { Status = "<font color='red'>Pending</font>"; } 
                    else if (StatusVal == 52) { Status = "First Leval Approved"; }
                    else if (StatusVal == 53) { Status = "First Leval Reject"; }
                    else if (StatusVal > 53) { Status = "First Leval Approved"; }
