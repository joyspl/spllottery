<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxDealerDepositApprovalByDirLastFinal.aspx.cs" Inherits="LTMSWebApp.TrxDealerDepositApprovalByDirLastFinal" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Approval by DSL"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="gridDivCustom" id="dvClaim" style="width: 80%; margin: auto; height: 40vh;" runat="server">
                        <asp:GridView ID="gvClaimUploadDtl" runat="server" CssClass="table table-bordered table-hover"
                           ...
                           <Columns>
                                ...
                                <asp:TemplateField HeaderText="Validity Dates">
                                    <ItemTemplate>
                    ...
                    <div class="well well-sm" style="width: 80%;margin: auto;margin-top: 15px;" >
                        <table style="width: 100%; vertical-align: text-top;" border="0">
                            <tr>
                                ...
                                <td style="width: 75%;"><asp:Button ID="btnCancel" runat="server" AccessKey="C" CssClass="btn btn-primary" OnClick="btnCancel_Click" Text="Cancel" ToolTip="Cancel (Alt + C)" /></td>
                            </tr>
                        </table>
                    </div>
                </asp:Panel>
