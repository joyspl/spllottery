...
{
    public partial class TrxViewLotteryClaimEntryPWT : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("Confirmed", "1"));
                items.Add(new ListItem("Rejected", "2"));
                items.Add(new ListItem("Second Leval Approved", "3"));
                items.Add(new ListItem("Second Leval Rejected", "4"));
                items.Add(new ListItem("Final Leval Approved", "5"));
                items.Add(new ListItem("Final Leval Rejected", "6"));
        ...
        private void BindGvData()
        {
            try
            {
                ...
                GvData.DataSource = objLtmsService.GetLotteryClaimEntryDtlByStatus(objInputParameter,1);//1==PWT entry
                GvData.DataBind();
