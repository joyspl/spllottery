<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxSpecialTicketClaimedFinalLevelApproval.aspx.cs" Inherits="LTMSWebApp.TrxSpecialTicketClaimedFinalLevelApproval" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Final Level Approval for Special Ticket Claimed Application"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                ...
                <div id="pnlDataDisplay" runat="server" style="position: relative;">
                    ...
                    <div class="gridDivCustom" style="height: 60vh;" id="gridDiv" runat="server">
                        <asp:GridView ID="GvData" runat="server" CssClass="table table-bordered table-hover"
                            ...
                            Width="2000px" OnRowDataBound="GvData_RowDataBound" OnRowCommand="GvData_RowCommand">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="Prize Amount" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPrizeAmount1" runat="server" Text='<%# Bind("SpecialTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Payable To Winner" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPayableToWinner1" runat="server" Text='<%# Bind("UpdatedSpecialTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
