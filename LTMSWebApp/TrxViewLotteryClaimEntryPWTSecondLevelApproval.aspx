<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxViewLotteryClaimEntryPWTSecondLevelApproval.aspx.cs" Inherits="LTMSWebApp.TrxViewLotteryClaimEntryPWTSecondLevelApproval" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Second Level Approval for PWT Prize Claimed Application"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                ...
                <div id="pnlDataDisplay" runat="server" style="position: relative;">
                    ...
                    <div class="gridDivCustom" style="height: 60vh;" id="gridDiv" runat="server">
                        <asp:GridView ID="GvData" runat="server" CssClass="table table-bordered table-hover"
                            ...
                            Width="3000px" OnRowCommand="GvData_RowCommand" OnRowDataBound="GvData_RowDataBound">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
