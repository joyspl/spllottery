<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxRequisitionApprovalSecondLevel.aspx.cs" Inherits="LTMSWebApp.TrxRequisitionApprovalSecondLevel" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Second Level Requisition Approval"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                ...
                <div id="pnlDataDisplay" runat="server" style="position: relative;">
                    ...
                    <div class="gridDivCustom" style="height: 60vh;" id="gridDiv" runat="server">
                        <asp:GridView ID="GvData" runat="server" CssClass="table table-bordered table-hover"
                            ...
                            Width="1800px" OnRowDataBound="GvData_RowDataBound">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
