<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxSuperTicketClaimedFinalLevelApproval.aspx.cs" Inherits="LTMSWebApp.TrxSuperTicketClaimedFinalLevelApproval" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Final Level Approval for Super Ticket Claimed Application"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                        ...
                        <asp:GridView ID="GvData" runat="server" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Prize Amount" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPrizeAmount1" runat="server" Text='<%# Bind("SuperTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Payable To Winner" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPayableToWinner1" runat="server" Text='<%# Bind("UpdatedSuperTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
