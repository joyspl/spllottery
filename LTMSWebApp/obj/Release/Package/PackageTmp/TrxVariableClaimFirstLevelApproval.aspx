<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxVariableClaimFirstLevelApproval.aspx.cs" Inherits="LTMSWebApp.TrxVariableClaimFirstLevelApproval" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="First Level Approval by DSL "></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
