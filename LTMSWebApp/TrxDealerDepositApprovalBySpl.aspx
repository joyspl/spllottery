<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxDealerDepositApprovalBySpl.aspx.cs" Inherits="LTMSWebApp.TrxDealerDepositApprovalBySpl" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Approve Deposit Amount By Spl"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">                
                 ...
                 <table style="width: 100%; vertical-align: text-top;" border="0">
                    <tr>
                        <td style="text-align: left; vertical-align: top; width: 50%;">
                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary" CommandName="Approve"  OnClick="btnSave_Click" />
                        </td>              
