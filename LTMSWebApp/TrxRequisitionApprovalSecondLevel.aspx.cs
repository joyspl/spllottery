...
{
    public partial class TrxRequisitionApprovalSecondLevel : System.Web.UI.Page
    {
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    else if (StatusVal == 4) { Status = "Second Leval Approved"; }
                    else if (StatusVal == 5) { Status = "Second Leval Reject"; }
