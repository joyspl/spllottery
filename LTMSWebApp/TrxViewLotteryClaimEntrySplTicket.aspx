<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxViewLotteryClaimEntrySplTicket.aspx.cs" Inherits="LTMSWebApp.TrxViewLotteryClaimEntrySplTicket" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Claimed Confirmation by Distributor"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                        ...
                        <tr>
                            ...
                            <td style="width: 50%;">
                                <div class="form-control" style="padding: 4px;">
                                    <asp:RadioButton ID="rdoApproveStatus1" GroupName="ApproveStatus" Checked="true" runat="server" Text="Approve" />
                        ...
                        <asp:GridView ID="GvData" runat="server" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Prize Amount" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPrizeAmount3" runat="server" Text='<%# Bind("SpecialTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Payable To Winner" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPayableToWinner3" runat="server" Text='<%# Bind("UpdatedSpecialTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
