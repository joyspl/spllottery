<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxViewLotteryClaimEntrySuperTicket.aspx.cs" Inherits="LTMSWebApp.TrxViewLotteryClaimEntrySuperTicket" %>
                        ...
                        <asp:GridView ID="GvData" runat="server" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Prize Amount" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPrizeAmount2" runat="server" Text='<%# Bind("SuperTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Payable To Winner" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPayableToWinner2" runat="server" Text='<%# Bind("UpdatedSuperTicketAmount") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
