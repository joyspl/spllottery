...
{
    public partial class TrxViewLotteryClaimEntrySplTicket : System.Web.UI.Page
    {
        ...
        private void BindGvData()
        {
            try
            {
                ...
                GvData.DataSource = objLtmsService.GetLotteryClaimEntryDtlByStatus(objInputParameter,3);//1==Special Ticket
                GvData.DataBind();
            ...
            try
            {
                ...
                {                   
                    if (dtInfo.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ClaimType == "3")
                        {
                            txtPrizeAmount.Text = dtInfo.Tables[0].Rows[0]["SpecialTicketAmount"].ToString();
                            txtPayableToWinner.Text = dtInfo.Tables[0].Rows[0]["UpdatedSpecialTicketAmount"].ToString();
                        }
