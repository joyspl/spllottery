...
{
    public partial class TrxPrizeApproval : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("Approve", "63"));
                items.Add(new ListItem("Reject", "64")); 
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    if (StatusVal == 62) { Status = "Pending"; }
                    else if (StatusVal == 63) { Status = "Approved"; }
