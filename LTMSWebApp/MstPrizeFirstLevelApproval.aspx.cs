...
{
    public partial class MstPrizeFirstLevelApproval : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            ...
            {               
                ...
                items.Add(new ListItem("Approved", "3"));
                items.Add(new ListItem("Reject", "4"));
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objPrize.SaveStatus = 3;
                }
                else if (((Button)sender).CommandName == "Reject")
                {
                    objPrize.SaveStatus = 4;
                }
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (StatusVal == 2) { Status = "<font color='red'>Approval Pending</font>"; }
                else if (StatusVal == 3) { Status = "First Leval Approved"; }
                else if (StatusVal == 4) { Status = "First Leval Reject"; }
                else if (StatusVal > 4) { Status = "First Leval Approved"; }
