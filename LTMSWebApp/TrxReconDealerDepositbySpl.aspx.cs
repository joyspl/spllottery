...
{
    public partial class TrxReconDealerDepositbySpl : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objDealerDeposit.BGValidityDay = (rdoReconStatus1.Checked == true ? 2 : 3);// 0-Draft, 1- Confirm, 2- Approve, 3-Realized,4-Not-Realized
        ...
        private void BindGvData()
        {
            try
            {
                ...
                GvData.DataSource = objLtmsService.GetDealerDepositViewForApprovalDtl(objInputParameter, 2);
                GvData.DataBind();
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            Session["ReportName"] = "DealerDepositReconBySplViewDtl";
