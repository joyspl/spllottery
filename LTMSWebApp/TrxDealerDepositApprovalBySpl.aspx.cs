...
{
    public partial class TrxDealerDepositApprovalBySpl : System.Web.UI.Page
    {
        ...
        private void BindGvData()
        {
            try
            {
                ...
                GvData.DataSource = objLtmsService.GetDealerDepositViewForApprovalDtl(objInputParameter, 2); // 1==Lottery Direcorate
                GvData.DataBind();
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            Session["ReportName"] = "DealerDepositApprovalBySpl";
