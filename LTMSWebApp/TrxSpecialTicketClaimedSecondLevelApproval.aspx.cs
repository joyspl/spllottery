...
{
    public partial class TrxSpecialTicketClaimedSecondLevelApproval : System.Web.UI.Page
    {
        ...
        private void BindGvData()
        {
            try
            {
                ...
                GvData.DataSource = objLtmsService.GetLotteryClaimEntryDtlByStatus(objInputParameter, 3);
                GvData.DataBind();
