...
{
    public partial class MstPrizeFinalLevelApproval : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            ...
            {               
                ...
                items.Add(new ListItem("<<--All-->>", "-4"));
                items.Add(new ListItem("Pending", "5"));
                items.Add(new ListItem("Approved", "7"));
                items.Add(new ListItem("Reject", "8"));
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objPrize.SaveStatus = 7;
                }
                else if (((Button)sender).CommandName == "Reject")
                {
                    objPrize.SaveStatus = 8;
                }
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (StatusVal == 5) { Status = "<font color='red'>Approval Pending</font>"; }
                else if (StatusVal == 7) { Status = "Final Leval Approved"; }
                else if (StatusVal == 8) { Status = "Final Leval Reject"; }
                else if (StatusVal > 8) { Status = "Final Leval Approved"; }
