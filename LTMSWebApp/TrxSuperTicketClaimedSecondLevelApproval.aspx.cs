...
{
    public partial class TrxSuperTicketClaimedSecondLevelApproval : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool IsUpdated = objLtmsService.UpdateApprovalByStausInLotteryClaimEntry(objRequisition, ReqId,2);
                if (IsUpdated == true)
                {
        ...
        private void BindGvData()
        {
            try
            {
                ...
                GvData.DataSource = objLtmsService.GetLotteryClaimEntryDtlByStatus(objInputParameter, 2);
                GvData.DataBind();
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    else if (StatusVal == 4) { Status = "First Leval Reject"; }                   
