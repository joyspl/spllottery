...
{
    public partial class TrxRequisitionByDealerApproval : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("<<--All-->>", "-50"));
                //items.Add(new ListItem("Draft", "0"));
                items.Add(new ListItem("Pending", "32"));
                items.Add(new ListItem("Approved", "33"));
                items.Add(new ListItem("Rejected", "34"));     
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    if (StatusVal == 32) { Status = "<font color='red'>Pending</font>"; }
                    else if (StatusVal == 33) { Status = "Approved"; }
                    else if (StatusVal == 34) { Status = "Rejected"; }                    
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            Session["ReportName"] = "RequisitionDealerApprovalDtl";
