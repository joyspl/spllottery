...
{
    public partial class TrxDealerDepositApprovalByDirFinal : System.Web.UI.Page
    {
      ...
      //  ClsLottery objClsLottery = new ClsLottery();
        ...
        private void BindClaimGvData()
        {
            try
            {
                ...
                gvClaimUploadDtl.DataSource = objLtmsService.GetDealerDepositDtlByReqId(Convert.ToInt64(hdUniqueId.Value),-2);
        ...
        protected void gvClaimUploadDtl_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    chkSelect.Visible = ((StatusVal == 2 || StatusVal == 3 || StatusVal == 4) ? false : true);
                }
                catch { }
            }
        }
