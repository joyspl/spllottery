...
{
    public partial class TrxReconLotteryClaimEntry : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
               // objValidateData.FillDropDownList(ddlDepositMethod, "DepositMethod","");
                ...
                items.Add(new ListItem("Realized", "3"));
                items.Add(new ListItem("Not-Realized", "4"));
        ...
        //        objDealerDeposit.SaveStatus = (rdoReconStatus1.Checked == true ? 3 : 4);// 0-Draft, 1- Confirm, 2- Approve, 3-Realized,4-Not-Realized
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    else if (StatusVal == 3) { Status = "Realized"; }
                    else if (StatusVal == 4) { Status = "Not-Realized"; }
