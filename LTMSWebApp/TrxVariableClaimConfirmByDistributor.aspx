<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxVariableClaimConfirmByDistributor.aspx.cs" Inherits="LTMSWebApp.TrxVariableClaimConfirmByDistributor" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Confirmation by Distributor"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                     ...
                     <div class="well well-sm" style="width: 80%;margin: auto;margin-top: 15px;" >
                        <table style="width: 100%; vertical-align: text-top;" border="0">
                            <tr>
                                ...
                                <td style="text-align: right; vertical-align: top; width: 75%;">
