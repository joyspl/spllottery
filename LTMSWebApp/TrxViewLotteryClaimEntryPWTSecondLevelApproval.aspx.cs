...
{
    public partial class TrxViewLotteryClaimEntryPWTSecondLevelApproval : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool IsUpdated = objLtmsService.UpdateApprovalByStausInLotteryClaimEntry(objRequisition, ReqId,1);
                if (IsUpdated == true)
                {
        ...
        private void BindGvData()
        {
            try
            {
                ...
                GvData.DataSource = objLtmsService.GetLotteryClaimEntryDtlByStatus(objInputParameter, 1);
                GvData.DataBind();
