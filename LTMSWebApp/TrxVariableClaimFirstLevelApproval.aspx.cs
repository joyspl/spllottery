...
{
    public partial class TrxVariableClaimFirstLevelApproval : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("Pending", "82"));
                items.Add(new ListItem("1st Level Approved", "84"));
        ...
        protected void gvClaimUploadDtl_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    ((CheckBox)e.Row.FindControl("chkSelect")).Visible = (StatusVal == 2 ? true : false);    
                }
                catch { }
            }
        }
