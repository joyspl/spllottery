...
{
    public partial class TrxVariableClaimConfirmByDistributor : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("Pending", "81"));
                items.Add(new ListItem("Claimed Ticket Uploaded", "82"));
        ...
        protected void gvClaimUploadDtl_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    ((CheckBox)e.Row.FindControl("chkSelect")).Visible = (StatusVal == 1?true:false);
