...
{
    public partial class TrxRequisitionApprovalFinalLevel : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("Pending", "4"));
                items.Add(new ListItem("Approve", "6"));
                items.Add(new ListItem("Reject", "7")); 
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    if (StatusVal == 4) { Status = "<font color='red'>Approval Pending</font>"; }                  
                    else if (StatusVal == 6) { Status = "Final Leval Approved"; }
                    else if (StatusVal == 7) { Status = "Final Leval Reject"; }
