...
{
    public partial class TrxTicketInventoryUnSoldFinalLevelApproval : System.Web.UI.Page
    {
        ...
        private void FillComboBox()
        {
            try
            {
                ...
                items.Add(new ListItem("<<--All-->>", "-100"));
                items.Add(new ListItem("Pending", "54"));
        ...
        protected void GvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    if (StatusVal == 54) { Status = "<font color='red'>Pending</font>"; }
                    else if (StatusVal == 56) { Status = "Final Leval Approved"; }
                    else if (StatusVal == 57) { Status = "Final Leval Reject"; }
                    else if (StatusVal > 57) { Status = "Final Leval Approved"; }
