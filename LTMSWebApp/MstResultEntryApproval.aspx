<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="MstResultEntryApproval.aspx.cs" Inherits="LTMSWebApp.MstResultEntryApproval" %>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Result Entry Approval"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
