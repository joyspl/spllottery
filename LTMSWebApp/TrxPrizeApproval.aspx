<%@ Page Title="" Language="C#" MasterPageFile="~/WebPageMaster.Master" AutoEventWireup="true" CodeBehind="TrxPrizeApproval.aspx.cs" Inherits="LTMSWebApp.TrxPrizeApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AppContentPlaceHolder" runat="server">
    <div class="container-fluid">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Prize</a></li>
            <li class="breadcrumb-item active">
                <asp:Label ID="lblHeader" runat="server" Text="Prize Approval"></asp:Label>
            </li>
        </ol>
        <div class="row">
            <div class="col-12">
                ...
                <div id="pnlDataDisplay" runat="server" style="position: relative;">
                    ...
                    <div class="gridDivCustom" style="height: 60vh;" id="gridDiv" runat="server">
                        <asp:GridView ID="GvData" runat="server" CssClass="table table-bordered table-hover"
                            ...
                            Width="1200px" OnRowDataBound="GvData_RowDataBound">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
